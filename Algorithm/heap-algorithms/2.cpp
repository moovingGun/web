...
int main() {
    cout << "=== 힙(Heap) 확인 알고리즘 (배열 버전) ===" << endl << endl;
    
    // 예시 1: 최대 힙인 배열
    int maxHeapArr[] = {100, 19, 36, 17, 3, 25, 1, 2, 7};
    int n1 = sizeof(maxHeapArr) / sizeof(maxHeapArr[0]);
    cout << "배열 1: ";
    printArray(maxHeapArr, n1);
    ...
    // 예시 2: 최대 힙이 아닌 배열
    int notMaxHeapArr[] = {10, 20, 30, 5, 15}; // 10의 자식 20이 더 큼
    int n2 = sizeof(notMaxHeapArr) / sizeof(notMaxHeapArr[0]);
    cout << "배열 2: ";
    printArray(notMaxHeapArr, n2);
    ...
    // 예시 3: 최소 힙인 배열
    int minHeapArr[] = {1, 2, 3, 7, 8, 9, 10};
    int n3 = sizeof(minHeapArr) / sizeof(minHeapArr[0]);
    cout << "배열 3: ";
    printArray(minHeapArr, n3);
    ...
    int userArr[1000]; // 최대 1000개까지 지원
